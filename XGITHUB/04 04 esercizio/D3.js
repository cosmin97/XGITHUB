...
*/const starWarsCharacterscharactersNames = [];
/* ESERCIZIO 2
...
// Verifica della tipologia di carico in base alla massa totale
if (crewMass < 500) {
...
for (let i = 0; i < femaleCharacters.length; i++) {
  ...
  const indexToRemove = charactersNames.indexOf(femaleName);
