...
*/
// Aggiungi un nuovo oggetto in ultima posizione nell'array "cars"
const newCar = {
    brand: 'BMW',
    model: 'SERIES3',
    color: 'white',
...
*/
  ...
  for (let i = 0; i < cars.length; i++) {
      // Controlla se la prima lettera della proprietà "color" è "b"
